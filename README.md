...
Example:
echo "echo 'my name is' && echo 'holberton'" | ./sodash 'my name is' 'holberton'
...
cd ../ ^-^ pwd /home/vagrant/holberton ^-^ cd - ^-^ pwd /home/vagrant/holberton/simple_shell
